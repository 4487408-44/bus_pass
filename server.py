    ...
    def do_POST(self):
        ...
        if self.path == '/register':
            ...
            if not username or not email or not password:
                return self.send_json_response(400, {"error": "Missing fields"})
        ...
        # ================= GET PASSES =================
            ...
            with sqlite3.connect(DB_PASSES) as conn:
                cursor = conn.cursor()
                cursor.execute('''
                    SELECT pass_type, bus_number, issue_date, expiry_date 
                    FROM passes 
